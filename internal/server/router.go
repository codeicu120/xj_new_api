...
func NewRouter(opts Options) *gin.Engine {
	...
	router.Any("/game/wali/topup", gameHandler.HighRiskAction("瓦力游戏上分成功分支暂未迁移"))
	router.Any("/game/wali/withdraw", gameHandler.HighRiskAction("瓦力游戏下分成功分支暂未迁移"))
	...
	router.Any("/game/lottery/topup", gameHandler.HighRiskAction("彩票游戏上分成功分支暂未迁移"))
	router.Any("/game/lottery/withdraw", gameHandler.HighRiskAction("彩票游戏下分成功分支暂未迁移"))
	...
	router.Any("/ucp/task/sign", ucpHandler.HighRiskAction("签到成功分支暂未迁移"))
	...
	router.Any("/ucp/task/invitecodeInput", ucpHandler.HighRiskAction("邀请码绑定成功分支暂未迁移"))
	router.Any("/ucp/task/adviewClick", ucpHandler.HighRiskAction("广告点击奖励成功分支暂未迁移"))
	...
	router.Any("/ucp/taskbox/taskboxopen", ucpHandler.HighRiskAction("任务宝箱开启成功分支暂未迁移"))
	...
	router.Any("/ucp/coinlog/exchange", ucpHandler.HighRiskAction("金币兑换成功分支暂未迁移"))
	router.Any("/ucp/vippkg", ucpHandler.VIPPkgIndex)
	router.Any("/ucp/vippkg/index", ucpHandler.VIPPkgIndex)
	router.Any("/ucp/vippkg/placeorder", ucpHandler.HighRiskAction("VIP 支付下单成功分支暂未迁移"))
	router.Any("/ucp/vippkg/coinorder", ucpHandler.HighRiskAction("VIP 金币购买成功分支暂未迁移"))
	router.Any("/ucp/coinpkg", ucpHandler.CoinPkgIndex)
	router.Any("/ucp/coinpkg/index", ucpHandler.CoinPkgIndex)
	router.Any("/ucp/coinpkg/placeorder", ucpHandler.HighRiskAction("金币套餐支付下单成功分支暂未迁移"))
	router.Any("/ucp/beanpkg", ucpHandler.BeanPkgIndex)
	router.Any("/ucp/beanpkg/index", ucpHandler.BeanPkgIndex)
	router.Any("/ucp/beanpkg/placeorder", ucpHandler.HighRiskAction("金豆套餐支付下单成功分支暂未迁移"))
	router.Any("/ucp/beanpkg/coinorder", ucpHandler.HighRiskAction("金豆金币购买成功分支暂未迁移"))
	...
	router.Any("/ucp/vodorder/create", ucpHandler.HighRiskAction("求片创建成功分支暂未迁移"))
	router.Any("/ucp/vodorder/support", ucpHandler.HighRiskAction("求片助力成功分支暂未迁移"))
